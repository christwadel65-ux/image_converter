...
- **Conversion de formats** : JPG, PNG, WebP, AVIF, BMP, TIFF, ICO
...
- **Contrôle de qualité** : Réglez la qualité pour JPG, WebP et AVIF
- **Métadonnées EXIF** : Préservez les données de votre appareil photo
- **Format AVIF** : Support du format moderne AVIF via ImageMagick pour une compression optimale
